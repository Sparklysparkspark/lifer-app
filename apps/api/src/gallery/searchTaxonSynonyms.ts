...
export const TAXON_SEARCH_SYNONYMS: Record<TaxonClass, string[]> = {
  ...
  squamata: ["lizard", "lizards", "snake", "snakes", "crocodile", "crocodiles", "alligator", "alligators", "caiman", "caimans"],
  ...
  marine_mollusks: ["shell", "shells", "mollusk", "mollusks", "mollusc", "molluscs", "snail", "snails", "clam", "clams"],
