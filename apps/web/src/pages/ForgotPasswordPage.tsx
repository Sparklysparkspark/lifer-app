      ...
      <div className="w-full max-w-sm space-y-4 rounded-xl border border-stone-200 bg-white p-8 shadow-sm">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <p className="text-sm text-stone-500">Enter your account email and we'll send a reset link.</p>
            <input
              type="email"
              placeholder="Email"
              value={email}
        ...
        <Link to="/login" className="block text-center text-sm text-stone-500 hover:underline">
          Back to login
        </Link>
      </div>
    </div>
